...
public class Login extends javax.swing.JFrame {
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        try {
            User u = this.d.encontrarUsuario(txtUsuario.getText());

            if (u != null) {
                char[] correctPass = u.getPass().toCharArray();
                if (Arrays.equals(correctPass, txtPass.getPassword())) {
                    App a = new App();
                    a.setVisible(true);
                    this.dispose();
                } else {
